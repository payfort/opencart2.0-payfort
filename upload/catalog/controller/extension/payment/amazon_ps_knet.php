<?php
class ControllerExtensionPaymentAmazonPSKnet extends Controller {
	...
	public function index() {
        ...
        $data['payment_method'] = 'amazon_ps_knet';
		return $this->load->view('extension/payment/amazon_ps', $data);
	}

	public function send()
    {
        $form = $this->amazonpsorderpayment->getPaymentRequestForm(AmazonPSConstant::AMAZON_PS_PAYMENT_METHOD_KNET, AmazonPSConstant::AMAZON_PS_INTEGRATION_TYPE_REDIRECTION);
