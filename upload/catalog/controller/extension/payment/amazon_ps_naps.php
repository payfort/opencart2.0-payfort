...
class ControllerExtensionPaymentAmazonPSNaps extends Controller {
	...
	public function index() {
        ...
        $data['payment_method'] = 'amazon_ps_naps';
	...
	public function send()
    {
        ...
        $form = $this->amazonpsorderpayment->getPaymentRequestForm(AmazonPSConstant::AMAZON_PS_PAYMENT_METHOD_NAPS, AmazonPSConstant::AMAZON_PS_INTEGRATION_TYPE_REDIRECTION);
