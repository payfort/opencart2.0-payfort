...
class ControllerExtensionPaymentAmazonPSValu extends Controller {
	...
	public function index() {
        ...
        $data['enter_valu_downpayment'] = $this->language->get('enter_valu_downpayment');
        $data['enter_valu_tou'] = $this->language->get('enter_valu_tou');
        $data['enter_valu_cashback'] = $this->language->get('enter_valu_cashback');
        ...
        $data['amazon_ps_valu_down_payment_status'] = $this->amazonpspaymentservices->getValuDownPaymentStatus();
        $data['amazon_ps_valu_down_payment_value'] = $this->amazonpspaymentservices->getValuDownPaymentValue();
