...
<div class="pf-iframe-background" id="div-pf-iframe" style="display:none">
    <div class="pf-iframe-container">
        <span class="pf-close-container">
            <i class="fa fa-times-circle pf-iframe-close" onclick="apsPayment.closePopup('<?php echo $payment_method; ?>')"></i>
        </span>
...
<script type="text/javascript"><!--
    var text_general_error = ' <?php echo $text_general_error; ?>';
    var amazon_ps_error_js_msg = [];
    <?php echo $amazon_ps_error_js_msg; ?>
//--></script>   
<script type="text/javascript"><!--
$('#button-confirm').bind('click', function () {
    AmazonPSCall.makePayment('<?php echo $payment_method; ?>', 'standard_checkout');
});
//--></script>
<style>
input.field-error {
